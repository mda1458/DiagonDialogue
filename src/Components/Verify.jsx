...
const Verify = () => {
  ...
  return (
    <div className="flex flex-col m-10 p-4 md:mx-36 md:my-12 md:p-28 bg-[#ffffff5d] rounded-2xl items-center justify-center h-[cal(100vh-5rem)]">
      ...
      <button
        className="flex items-center justify-center my-10 md:mt-16 px-4 py-2 border border-gray-300 rounded-md bg-white text-2xl text-white bg-gradient-to-r from-[#651C32] via-gray-600 to-[#0E0D16] outline-none border-none disabled:from-gray-600 disabled:via-gray-600 disabled:to-gray-600"
